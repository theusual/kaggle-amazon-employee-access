...
#credit to Miroslaw Horbal for the starter code
...
def main(train='Data\\train.csv', test='Data\\test.csv', submit='Submissions\logistic_pred.csv'):
    ...
    Cvals = np.logspace(-10, 10, 750, base=2)
    for C in Cvals:
        model.C = C
        score = cv_loop(Xt, y, model, N)
